<%@ page import="java.util.ArrayList, educational.entertainment.models.User, educational.entertainment.models.Course,educational.entertainment.models.Achievement" %>
   ...
   <section class="about text-center" id="aboutwebsite">
    ...
    <div class="container">
       ...
       <% ArrayList<Achievement> AL=( ArrayList<Achievement>)request.getAttribute("Ach");
          //int fullmark=(int)session.getAttribute("p");
       for(int i=0;i<AL.size();i++){
    	   
    	   int x;
         if(AL.get(i).getScore()!=0)
        	 x=300/AL.get(i).getScore()*100;
        	else x=0;%>
  		<p> </p>
  	
        <div class="col-lg-6">
           <div class="progress">
              <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: <%=x%>%;background-color:#C13832">
